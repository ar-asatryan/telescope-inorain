...
import { Employee, EmployeeStatus, EnglishLevel } from '../entities/employee.entity';
import { EmployeeSkill, SkillLevel } from '../entities/employee-skill.entity';
...
async function seed() {
  try {
    ...
    console.log('Employee skills assigned');
